...
from kobo_sync_rat.models.kobo.configuration import (
    KoboResourceContainer,
    KoboUserProfile,
)
...
LOCAL_RESOURCES = {
    ...
    "audiobook_subscription_orange_deal_inclusion_url": "/audiobook-inclusion",
    ...
    "client_authd_referral": "/v1/auth/referral",
    ...
    "instapaper_link_account_start": "/linkinstapaper",
    ...
    "terms_of_sale_page": "/termsofsale",
